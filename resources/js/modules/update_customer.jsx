...
import { UpdateCustomer } from '@/services/customer_service';
...
export const UpdateCustomerModule = ({ customer, onUpdate }) => {
    const form = useForm({
    ...
    async function onSubmit(values) {
        ...
        const res = await UpdateCustomer({
            ...
            address: {
                address_id: formatted.address_id,
            ...
            <Dialog>
                ...
                <DialogContent>
                    ...
                    <FormProvider {...form}>
                        ...
                        <DialogFooter>
                            <Button onClick={form.handleSubmit(onSubmit)}>Atualizar</Button>
                            <DialogClose>
